...
export type DrawingSubTool = 'draw-select' | 'block' | 'db-block' | 'code-block' | 'localdb-block' | 'chart-block' | 'etl-block' | 'rectangle' | 'ellipse' | 'ortho-arrow' | 'freedraw' | 'text' | 'diamond'
